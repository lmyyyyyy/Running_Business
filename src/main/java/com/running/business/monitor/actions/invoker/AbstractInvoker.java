...
import com.running.business.monitor.actions.commands.Command;
...
import com.running.business.monitor.actions.exception.InvokerNotFoundException;
import com.running.business.monitor.actions.exception.OrderLengthInvalidException;
...
public abstract class AbstractInvoker<C> implements Invoker<C>, InitializingBean, ApplicationContextAware {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        commands = this.getCommandsWithAnnotation(com.running.business.monitor.annotation.Command.class);
    ...
    private boolean isCommandBelongToInvoker(Command command, String name) {
        ...
        com.running.business.monitor.annotation.Command annotation = command.getClass()
                .getAnnotation(com.running.business.monitor.annotation.Command.class);
    ...
    private class CommandOrderComparator<T> implements Comparator<T> {
        ...
        private int getOrder(T o1) {
            ...
            com.running.business.monitor.annotation.Command annotation =
                    o1.getClass().getAnnotation(com.running.business.monitor.annotation.Command.class);
            if (annotation == null) {
                return Integer.MAX_VALUE;
            }
