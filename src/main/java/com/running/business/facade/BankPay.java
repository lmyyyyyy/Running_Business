...
public class BankPay {
    private static final Logger LOGGER = LoggerFactory.getLogger(BankPay.class);

    public void bankPay(double money, HttpServletRequest request) {
        LOGGER.debug("#####正在使用银行卡 支付 : ¥" + money);
        this.securityCheck();
